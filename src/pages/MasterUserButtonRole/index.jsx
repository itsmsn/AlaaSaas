...
const MasterUserButtonRolePage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_28.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[27px] w-[70%] md:w-full">
              <Text
              ...
              <div className="flex md:flex-col flex-row gap-[21px] items-center justify-start mt-[23px] w-[84%] md:w-full">
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mt-[31px] w-full">
                <CheckBox
                  className="font-medium leading-[normal] text-base text-left"
                  inputClassName="border border-blue-800 border-solid mr-[5px]"
                  name="canadddata"
                  id="canadddata"
                  label="Can Add Data"
                  size="xs"
...
export default MasterUserButtonRolePage;
