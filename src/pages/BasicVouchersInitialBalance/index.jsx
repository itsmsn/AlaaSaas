...
const BasicVouchersInitialBalancePage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_50.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            <div className="flex sm:h-[125px] h-[158px] md:h-[672px] justify-end relative w-full">
              ...
              <div className="absolute sm:h-[125px] h-[158px] md:h-[672px] inset-[0] justify-center m-auto w-full">
                <Img
                  ...
                  src="images/img_rectangle16_20.png"
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="flex h-[428px] sm:h-[442px] md:h-[637px] justify-end mt-[15px] relative w-full">
                ...
                <div className="absolute bg-white-A700 border border-gray-300_08 border-solid flex flex-col h-full inset-[0] items-center justify-center m-auto py-3.5 rounded-lg w-full">
                  <div className="flex flex-col items-center justify-start mb-[46px] w-full">
                    <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[95%] md:w-full">
                      ...
                      <div className="flex flex-row gap-[9px] items-center justify-center md:ml-[0] ml-[113px] w-auto">
                        <Text
                          className="text-base text-blue_gray-300_17 w-auto"
                          size="txtIBMPlexSansMedium16Bluegray30017"
                        >
                      ...
                      <div className="flex flex-col items-center justify-center md:ml-[0] ml-[113px] w-auto">
                        <Text
                          className="text-base text-blue_gray-300_17 w-auto"
                          size="txtIBMPlexSansMedium16Bluegray30017"
                        >
                      ...
                      <Img
                        className="h-3 md:ml-[0] ml-[19px] md:mt-0 mt-[5px] w-3"
                        src="images/img_svgexport1826.svg"
                        alt="svgexport1826_Three"
                      />
                      <div className="flex flex-row gap-[9px] items-center justify-center md:ml-[0] ml-[104px] w-auto">
                        <Text
                          className="text-base text-blue_gray-300_17 w-auto"
                          size="txtIBMPlexSansMedium16Bluegray30017"
                        >
...
export default BasicVouchersInitialBalancePage;
