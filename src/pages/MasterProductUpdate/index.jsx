...
const MasterProductUpdatePage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_22.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              ...
              <div className="flex sm:flex-col flex-row gap-4 items-center justify-start mt-[25px] w-[37%] md:w-full">
              ...
              <Input
                ...
                wrapClassName="border border-blue-800 border-solid flex ml-0.5 md:ml-[0] mt-[26px] shadow-bs w-[17%]"
                prefix={
                  <Img
                ...
                size="xs"
              ></Input>
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[35px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-center justify-start mb-[46px] w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-[94%] md:w-full">
                    ...
                    <div className="flex flex-row gap-[9px] items-center justify-center md:ml-[0] ml-[110px] w-auto">
                      <Text
                        className="text-base text-blue_gray-300_17 w-auto"
                        size="txtIBMPlexSansMedium16Bluegray30017"
                      >
                    ...
                    <div className="flex flex-row gap-[9px] items-center justify-center md:ml-[0] ml-[88px] w-auto">
                      <Text
                        className="text-base text-blue_gray-300_17 w-auto"
                        size="txtIBMPlexSansMedium16Bluegray30017"
                      >
...
export default MasterProductUpdatePage;
