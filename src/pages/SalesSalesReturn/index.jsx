...
const SalesSalesReturnPage = () => {
  const table11Data = React.useRef([
    {
      rowcode: "code",
  ...
  const table11Columns = React.useMemo(() => {
    ...
    return [
      table11ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table11ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table11ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table11ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table11ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table11ColumnHelper.accessor("rowquantity", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table11ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table11ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table11ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table11ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table11ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_43.svg" alt="group" />
      ),
            ...
            <div className="flex sm:h-[146px] h-[158px] md:h-[611px] justify-end relative w-full">
              ...
              <div className="absolute sm:h-[146px] h-[158px] md:h-[611px] inset-[0] justify-center m-auto w-full">
                <Img
                  ...
                  src="images/img_rectangle16_13.png"
...
export default SalesSalesReturnPage;
