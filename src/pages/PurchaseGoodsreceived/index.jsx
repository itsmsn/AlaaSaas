...
const PurchaseGoodsreceivedPage = () => {
  ...
  const table4Columns = React.useMemo(() => {
    ...
    return [
      table4ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table4ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table4ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table4ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table4ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table4ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table4ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table4ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table4ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table4ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_34.svg" alt="group" />
      ),
    ...
    <>
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <Sidebar4 className="!sticky !w-[250px] bg-blue-800 flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-500_31 border-solid flex flex-col items-center justify-start mt-5 p-3.5 rounded w-full">
                <div className="flex flex-col items-center justify-start mb-2 w-[99%] md:w-full">
                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-1.5 w-[97%] md:w-full">
...
export default PurchaseGoodsreceivedPage;
