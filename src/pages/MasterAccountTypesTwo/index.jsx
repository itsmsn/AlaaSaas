...
const MasterAccountTypesTwoPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_11.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="bg-gray-50_05 md:h-[487px] h-[606px] sm:h-[813px] mt-[5px] p-[23px] sm:px-5 relative shadow-bs4 w-[94%] md:w-full">
              <div className="flex flex-col h-full items-start justify-start ml-[13px] my-auto w-[41%]">
                <div className="flex flex-col relative w-[81%]">
                  <div className="flex flex-col justify-start mx-auto w-full">
                    <div className="flex flex-col relative w-full">
                      <div className="flex flex-row gap-[13px] items-center justify-between mx-auto w-auto">
                        <div className="bg-blue-800 flex flex-col h-[18px] items-center justify-start p-1 rounded-[50%] w-[18px]">
                      ...
                      <div className="h-[58px] ml-[31px] mt-[-14px] w-[70%] z-[1]">
                        <Line className="bg-black-900 h-[50px] mb-[-10.3px] w-px z-[1]" />
                        <div className="flex flex-row items-center justify-between mt-auto mx-auto w-full">
                          ...
                          <Text
                            ...
                            size="txtIBMPlexSansMedium14Bluegray40019"
                          >
                            Asset
                          </Text>
                          <Img
                    ...
                    <List
                      className="flex flex-col gap-px md:ml-[0] ml-[31px] w-[77%]"
                      orientation="vertical"
                    >
                      <div className="h-11 relative w-[90%]">
                        <Line className="bg-black-900 h-9 mb-[-10.6px] w-px z-[1]" />
                        <div className="flex flex-row items-center justify-between mt-auto mx-auto w-full">
                          <Img
                            className="h-2.5"
                            src="images/img_car_blue_gray_400_19.svg"
                      ...
                      <div className="h-11 relative w-[97%]">
                        <Line className="bg-black-900 h-9 mb-[-10.6px] w-px z-[1]" />
                        <div className="flex flex-row items-center justify-between mt-auto mx-auto w-full">
                          <Img
                            className="h-2.5"
                      ...
                      <div className="h-[45px] relative w-full">
                        <Line className="bg-black-900 h-9 mb-[-10px] w-px z-[1]" />
                        <div className="flex flex-row items-start justify-between mt-auto mx-auto w-full">
                          <Img
                  ...
                  <div className="h-[45px] mb-[134px] mt-[-NaNpx] mx-auto w-4/5 z-[1]">
                    <Line className="bg-black-900 h-9 mb-[-10px] w-px z-[1]" />
                    <div className="flex flex-row items-start justify-between mt-auto mx-auto w-full">
                      <Img
                        className="h-2.5 mt-1"
                  ...
                  <div className="h-11 ml-auto mr-[13px] mt-[-0.69px] w-[88%] z-[1]">
                    <Line className="bg-black-900 h-9 mb-[-10.63px] w-px z-[1]" />
                    <div className="flex flex-row items-center justify-between mt-auto mx-auto w-full">
                      <Img
                        className="h-2.5"
                        src="images/img_car_blue_gray_400_19.svg"
                ...
                <div className="h-11 md:ml-[0] ml-[31px] relative w-[67%]">
                  <Line className="bg-black-900 h-9 mb-[-10.6px] w-px z-[1]" />
                  <div className="flex flex-row items-center justify-between mt-auto mx-auto w-full">
                    <Img
                      className="h-2.5"
                ...
                <div className="md:h-[109px] sm:h-[381px] h-[84px] mt-[25px] relative w-full">
                  <div className="flex flex-row h-full items-end justify-start md:pr-10 sm:pr-5 pr-[66px] w-[85%]">
                    <Img
                      className="h-[18px] my-[5px] w-[18px]"
                  ...
                  <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
                    <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between w-full">
                      <div className="h-[57px] mb-[5px] sm:mt-0 mt-[22px] relative w-[4%] sm:w-full">
                        <Line className="bg-blue-800 h-[41px] mb-[-2px] ml-auto mr-2 w-px z-[1]" />
                        <Img
                      ...
                      <div className="flex flex-col gap-7 justify-start">
                        <Text
                          className="bg-white-A700 border border-blue-800 border-solid h-7 justify-center mr-[69px] px-3 py-[3px] rounded-sm text-base text-blue-800 text-shadow-ts w-auto"
                          size="txtIBMPlexSansSemiBold16Blue800"
                        >
                          Add
                        </Text>
                        <div className="flex flex-row gap-3 items-center justify-between md:ml-[0] ml-[7px] w-[95%] md:w-full">
                          <Img
                            className="h-2.5"
                            src="images/img_car.svg"
                            alt="carthirteen"
                ...
                <div className="flex sm:flex-col flex-row sm:gap-5 items-end justify-start mt-7 w-[84%] md:w-full">
                  <Img
              ...
              <div className="absolute flex flex-col md:gap-10 gap-[68px] h-max inset-y-[0] items-center justify-start left-[4%] my-auto w-[1%]">
                <Line className="bg-blue-800 h-[401px] w-px" />
...
export default MasterAccountTypesTwoPage;
