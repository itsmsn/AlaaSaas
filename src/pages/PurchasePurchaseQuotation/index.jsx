...
const PurchasePurchaseQuotationPage = () => {
  ...
  const table2Columns = React.useMemo(() => {
    ...
    return [
      table2ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table2ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table2ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table2ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table2ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table2ColumnHelper.accessor("rowquantity", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table2ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table2ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table2ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table2ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table2ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_32.svg" alt="group" />
      ),
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-500_31 border-solid flex flex-col items-center justify-start mt-5 p-3.5 rounded w-full">
                <div className="flex flex-col items-start justify-start w-[99%] md:w-full">
                  ...
                  <div className="flex md:flex-col flex-row gap-6 items-center justify-start mt-[22px] w-[66%] md:w-full">
...
export default PurchasePurchaseQuotationPage;
