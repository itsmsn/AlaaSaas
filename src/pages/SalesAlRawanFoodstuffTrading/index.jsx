...
const SalesAlRawanFoodstuffTradingPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_44.svg" alt="group" />
      ),
            ...
            <div className="flex sm:h-[125px] h-[158px] md:h-[673px] justify-end relative w-full">
              ...
              <div className="absolute sm:h-[125px] h-[158px] md:h-[673px] inset-[0] justify-center m-auto w-full">
                <Img
                  ...
                  src="images/img_rectangle16_14.png"
                  alt="rectanglesixtee"
                />
                <div className="absolute sm:h-[125px] h-[158px] md:h-[673px] inset-[0] justify-center m-auto w-full">
...
export default SalesAlRawanFoodstuffTradingPage;
