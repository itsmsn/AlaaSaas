...
const MasterProductColorsPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_26.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[27px] w-[78%] md:w-full">
              <Text
              ...
              <div className="flex md:flex-col flex-row gap-[51px] items-center justify-start mt-[23px] w-[73%] md:w-full">
                <div className="flex sm:flex-col flex-row gap-[21px] items-center justify-between w-[74%] md:w-full">
                  <div className="md:h-12 h-[57px] relative w-[70%] sm:w-full">
                    <Input
                      name="group370"
              ...
              <div className="flex sm:flex-col flex-row gap-[51px] items-center justify-start ml-0.5 md:ml-[0] mt-7 w-[44%] md:w-full">
                <Input
                  name="frame1213"
              ...
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[27px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-start justify-start mb-[47px] w-full">
                  <div className="flex flex-row sm:gap-10 items-start justify-between ml-10 md:ml-[0] w-[88%] md:w-full">
                  ...
                  <div className="flex flex-col gap-[59px] items-center justify-start ml-10 md:ml-[0] mt-[78px] w-[91%] md:w-full">
              ...
              <div className="flex flex-row font-roboto gap-3 items-start justify-start md:ml-[0] ml-[287px] mt-[23px] w-auto">
                <Button
...
export default MasterProductColorsPage;
