...
const MasterVATPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_2.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-[51px] items-center justify-start mt-[22px] w-[94%] md:w-full">
                <div className="flex md:flex-col flex-row gap-[23px] items-center justify-between w-[83%] md:w-full">
                  <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-[83%] md:w-full">
                    <div className="md:h-12 h-[57px] relative w-[49%] md:w-full">
                      <Input
                        name="group147"
                    ...
                    <div className="h-[57px] relative w-[49%] md:w-full">
                      ...
                      <div className="bg-white-A700 border border-blue_gray-100_06 border-solid flex flex-col gap-[15px] justify-start mt-auto mx-auto rounded w-full">
                        ...
                        <Text
                          className="mb-2.5 ml-3 md:ml-[0] mr-[252px] text-blue_gray-100_05 text-sm"
              ...
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[27px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-start justify-start mb-[9px] w-full">
                  <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between ml-10 md:ml-[0] w-[88%] md:w-full">
                    <div className="flex flex-row items-center justify-between w-[53%] sm:w-full">
                  ...
                  <div className="flex flex-col gap-5 items-center justify-start ml-10 md:ml-[0] mt-[38px] w-[91%] md:w-full">
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <Text
                        className="md:ml-[0] ml-[391px] text-blue_gray-900_01 text-sm"
                        size="txtIBMPlexSansMedium14Bluegray90001"
                      >
                        0
                      </Text>
                      <Img
                        className="h-5 md:ml-[0] ml-[431px] w-[116px]"
                    ...
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <Text
                        className="md:ml-[0] ml-[394px] text-blue_gray-900_01 text-sm"
                        size="txtIBMPlexSansMedium14Bluegray90001"
                      >
                        5
                      </Text>
                    ...
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <Text
                        className="md:ml-[0] ml-[386px] text-blue_gray-900_01 text-sm"
                        size="txtIBMPlexSansMedium14Bluegray90001"
                      >
                        9
                      </Text>
