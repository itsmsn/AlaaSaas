...
const MasterCustomerUploadPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_7.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              ...
              <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start mt-[31px] w-1/2 md:w-full">
                <div className="bg-white-A700 border border-dashed border-gray-500_35 flex flex-col items-center justify-start p-3 rounded w-[48%] sm:w-full">
                ...
                <div className="bg-white-A700 border border-blue-800 border-solid flex flex-row gap-[25px] items-center justify-start mb-[7px] ml-4 sm:ml-[0] px-3 py-[9px] shadow-bs w-auto">
                  <Img
                    className="h-6 w-6"
                ...
                <div className="bg-white-A700 border border-blue-800 border-solid flex flex-row gap-[25px] items-center justify-start mb-[7px] sm:ml-[0] ml-[13px] px-3 py-[9px] shadow-bs w-auto">
                  <Img
                    className="h-6 w-6"
              ...
              <Input
                ...
                wrapClassName="border border-blue-800 border-solid flex ml-0.5 md:ml-[0] mt-7 shadow-bs w-[17%]"
                prefix={
                  <Img
                ...
                size="xs"
              ></Input>
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-6 py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-center justify-start mb-[46px] w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-[94%] md:w-full">
                    ...
                    <div className="flex flex-row gap-[9px] items-center justify-center md:ml-[0] ml-[97px] w-auto">
                      <Text
                        className="text-base text-blue_gray-300_17 w-auto"
                        size="txtIBMPlexSansMedium16Bluegray30017"
                      >
                    ...
                    <div className="flex flex-row gap-[9px] items-center justify-center md:ml-[0] ml-[75px] w-auto">
                      <Text
                        className="text-base text-blue_gray-300_17 w-auto"
                        size="txtIBMPlexSansMedium16Bluegray30017"
                      >
                    ...
                    <div className="flex flex-row gap-[75px] items-center justify-center md:ml-[0] ml-[75px] w-[22%] md:w-full">
...
export default MasterCustomerUploadPage;
