...
const StocksOpeningStocksPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_67.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            <div className="flex sm:h-[125px] h-[158px] md:h-[673px] justify-end relative w-full">
              ...
              <div className="absolute sm:h-[125px] h-[158px] md:h-[673px] inset-[0] justify-center m-auto w-full">
                <Img
                  ...
                  src="images/img_rectangle16_37.png"
                  alt="rectanglesixtee"
                />
                <div className="absolute sm:h-[125px] h-[158px] md:h-[673px] inset-[0] justify-center m-auto w-full">
                            ...
                            <div className="flex flex-col h-11 items-center justify-start outline outline-[1px] outline-gray-300_08 p-0.5 rounded-[50%] w-11">
                              <div className="flex flex-col h-10 items-center justify-start w-10">
                                <Img
                                  ...
                                  src="images/img_mheader_40x40.png"
                                  alt="mheader"
                                />
                              </div>
                            </div>
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-500_31 border-solid flex md:flex-col flex-row gap-6 items-center justify-start mt-5 p-3.5 rounded w-full">
                <div className="md:h-[45px] h-[57px] ml-0.5 md:ml-[0] relative w-[32%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-[13px] w-full">
                ...
                <List
                  className="md:flex-1 sm:flex-col flex-row gap-[21px] grid grid-cols-2 md:ml-[0] ml-[21px] w-[22%] md:w-full"
                ...
                <Button
                  className="border border-blue-800 border-solid cursor-pointer font-medium leading-[normal] mb-[3px] min-w-[201px] md:ml-[0] ml-[515px] text-base text-center"
                  shape="square"
                >
                  Apply Cost Center To All
                </Button>
              </div>
              <div className="flex h-[428px] sm:h-[442px] md:h-[747px] justify-end mt-[15px] relative w-full">
                ...
                <div className="absolute bg-white-A700 border border-gray-300_08 border-solid flex flex-col h-full inset-[0] items-center justify-center m-auto py-3.5 rounded-lg w-full">
                  <div className="flex flex-col items-center justify-start mb-[46px] w-full">
                    <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-[96%] md:w-full">
                      <div className="flex flex-row gap-2.5 items-start justify-between w-[12%] md:w-full">
                        <Text
                      ...
                      <div className="flex flex-row gap-2.5 items-start justify-center w-[13%] md:w-full">
                        <Text
                          className="text-base text-blue_gray-300_17"
                          size="txtIBMPlexSansMedium16Bluegray30017"
                        >
                      ...
                      <div className="flex flex-row gap-2.5 items-start justify-center w-[12%] md:w-full">
                        <Text
                          className="text-base text-blue_gray-300_17"
                          size="txtIBMPlexSansMedium16Bluegray30017"
                        >
                      ...
                      <div className="flex flex-row gap-3 items-start justify-center pt-0.5 w-[9%] md:w-full">
                        <Text
                          className="text-base text-blue_gray-300_17"
                          size="txtIBMPlexSansMedium16Bluegray30017"
                        >
                      ...
                      <div className="flex flex-row gap-2.5 items-start justify-between w-[9%] md:w-full">
                        <Text
                          className="text-base text-blue_gray-300_17"
                          size="txtIBMPlexSansMedium16Bluegray30017"
                        >
...
export default StocksOpeningStocksPage;
