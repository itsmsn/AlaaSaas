...
const inputConvertedCurrencyOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];

const MasterCurrencyConvertionPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_5.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-3 items-center justify-between mt-[23px] w-full">
                <div className="flex md:flex-1 md:flex-col flex-row gap-2 items-center justify-between w-[88%] md:w-full">
                  <div className="gap-[25px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-between w-[86%] md:w-full">
                    <div className="md:h-[45px] h-[57px] relative w-full">
                      <div className="absolute bg-white-A700 border border-blue_gray-100_06 border-solid bottom-[0] flex flex-col gap-4 inset-x-[0] items-center justify-start mx-auto rounded w-full">
                        <Line className="bg-white-A700 h-px w-[27%]" />
                        <Text
                    ...
                    <div className="md:h-[45px] h-[57px] relative w-full">
                      <div className="absolute bg-white-A700 border border-blue_gray-100_06 border-solid bottom-[0] flex flex-col gap-3 inset-x-[0] justify-start mx-auto rounded w-full">
                        <Line className="bg-white-A700 h-px md:ml-[0] ml-[18px] mr-[115px] w-[48%]" />
                        <SelectBox
                          className="leading-[normal] mb-2.5 mx-auto text-blue_gray-100_05 text-left text-sm w-[91%] sm:w-full"
                          ...
                          isMulti={false}
                          name="group523"
                          options={inputConvertedCurrencyOptionsList}
                          isSearchable={false}
                          placeholder="Input converted currency"
                        />
                      </div>
                      <Text
                        className="absolute left-[11%] text-gray-600_21 text-sm top-[0]"
                        size="txtIBMPlexSansMedium14Gray60021"
                      >
                        Converted Currency
                      </Text>
              ...
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[27px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col gap-[11px] justify-start mb-[247px] w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between ml-10 md:ml-[0] w-[88%] md:w-full">
                    <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[76%] md:w-full">
                      ...
                      <div className="flex flex-row gap-[9px] items-center justify-center ml-40 md:ml-[0] w-auto">
                        <Text
                          className="text-base text-blue_gray-300_17 w-auto"
                          size="txtIBMPlexSansMedium16Bluegray30017"
                        >
...
export default MasterCurrencyConvertionPage;
