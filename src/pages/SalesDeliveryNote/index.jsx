...
const SalesDeliveryNotePage = () => {
  ...
  const table10Columns = React.useMemo(() => {
    ...
    return [
      table10ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table10ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table10ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table10ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table10ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table10ColumnHelper.accessor("rowquantity", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table10ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table10ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table10ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table10ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table10ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_41.svg" alt="group" />
      ),
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-500_31 border-solid flex flex-col items-center justify-start mt-5 p-3.5 rounded w-full">
                <div className="flex flex-col items-center justify-start mb-2 w-[99%] md:w-full">
                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-1.5 w-[97%] md:w-full">
                    <div className="flex md:flex-col flex-row md:gap-[50px] items-center justify-between w-[66%] md:w-full">
                      <div className="md:h-[45px] h-[57px] relative w-[51%] md:w-full">
                        <div className="absolute bg-white-A700 border border-blue_gray-100_06 border-solid bottom-[0] flex flex-col gap-3 inset-x-[0] justify-start mx-auto rounded w-full">
...
export default SalesDeliveryNotePage;
