...
const inputCounrtyNameOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start mt-[23px] w-[94%] md:w-full">
                <div className="md:h-12 h-[57px] relative w-[33%] md:w-full">
                  <Input
                    name="groupEightyTwo"
                ...
                <div className="md:h-[45px] h-[57px] ml-6 md:ml-[0] relative w-[33%] md:w-full">
                  <div className="absolute bg-white-A700 border border-blue_gray-100_06 border-solid bottom-[0] flex flex-col gap-3 inset-x-[0] justify-start mx-auto rounded w-full">
                    <Line className="bg-white-A700 h-px md:ml-[0] ml-[21px] mr-[214px] w-[30%]" />
                    <SelectBox
                      ...
                      isMulti={false}
                      name="group546"
                      options={inputCounrtyNameOptionsList}
                      isSearchable={false}
                      placeholder="Input counrty name"
                    />
                  </div>
                  <Text
                    className="absolute left-[8%] text-gray-600_21 text-sm top-[0]"
                ...
                <div className="bg-white-A700 border border-blue-800 border-solid flex flex-row gap-[25px] items-center justify-start md:ml-[0] ml-[23px] md:mt-0 my-[7px] px-3 py-[9px] shadow-bs w-auto">
                  <Img
                    className="h-6 w-6"
                ...
                <div className="bg-white-A700 border border-blue-800 border-solid flex flex-row gap-[25px] items-center justify-start md:ml-[0] ml-[51px] md:mt-0 my-[7px] px-3 py-[9px] shadow-bs w-auto">
                  <Img
                    className="h-6 w-6"
              ...
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[27px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-start justify-start mb-3.5 w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between ml-10 md:ml-[0] w-[88%] md:w-full">
                  ...
                  <div className="flex flex-col items-center justify-start ml-10 md:ml-[0] mt-[38px] w-[91%] md:w-full">
                    <List
                      className="flex flex-col gap-[19.5px] items-center pt-[180px] w-full"
                    ...
                    >
                      <div className="flex flex-1 md:flex-col flex-row md:gap-5 items-center justify-start my-0 w-full">
                        ...
                        <Text
                          className="md:ml-[0] ml-[374px] text-blue_gray-900_01 text-sm"
                          size="txtIBMPlexSansMedium14Bluegray90001"
                        >
                          United Arab Emirates Delete
                        </Text>
                        <Img
                          className="h-5 md:ml-[0] ml-[258px] w-[116px]"
                      ...
                      <div className="flex flex-1 md:flex-col flex-row md:gap-5 items-start justify-start my-0 w-full">
                        ...
                        <Text
                          className="md:ml-[0] ml-[396px] text-blue_gray-900_01 text-sm"
                          size="txtIBMPlexSansMedium14Bluegray90001"
                        >
                          United Arab Emirates Delete
                        </Text>
                      ...
                      <div className="flex flex-1 md:flex-col flex-row md:gap-5 items-center justify-start my-0 w-full">
                        ...
                        <Text
                          className="md:ml-[0] ml-[350px] text-blue_gray-900_01 text-sm"
                          size="txtIBMPlexSansMedium14Bluegray90001"
                        >
                          United Arab Emirates Delete
                        </Text>
                      ...
                      <div className="flex flex-1 md:flex-col flex-row md:gap-5 items-start justify-start my-0 w-full">
                        ...
                        <Text
                          className="md:ml-[0] ml-[370px] text-blue_gray-900_01 text-sm"
                          size="txtIBMPlexSansMedium14Bluegray90001"
                        >
                          United Arab Emirates Delete
                        </Text>
                      ...
                      <div className="flex flex-1 md:flex-col flex-row md:gap-5 items-start justify-start my-0 w-full">
                        ...
                        <Text
                          className="md:ml-[0] ml-[399px] text-blue_gray-900_01 text-sm"
                          size="txtIBMPlexSansMedium14Bluegray90001"
                        >
                          United Arab Emirates Delete
                        </Text>
                      ...
                      <div className="flex flex-1 md:flex-col flex-row md:gap-5 items-start justify-start my-0 w-full">
                        ...
                        <Text
                          className="md:ml-[0] ml-[392px] text-blue_gray-900_01 text-sm"
                          size="txtIBMPlexSansMedium14Bluegray90001"
                        >
                          United Arab Emirates Delete
                        </Text>
                      ...
                      <div className="flex flex-1 md:flex-col flex-row md:gap-5 items-center justify-start my-0 w-full">
                        ...
                        <Text
                          className="md:ml-[0] ml-[403px] text-blue_gray-900_01 text-sm"
                          size="txtIBMPlexSansMedium14Bluegray90001"
                        >
                          United Arab Emirates Delete
                        </Text>
