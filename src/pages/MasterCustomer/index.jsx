...
const MasterCustomerPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_6.svg" alt="group" />
      ),
                ...
                <div className="flex flex-col items-center justify-start mb-[7px] w-full">
                  ...
                  >
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <Text
                        className="md:ml-[0] ml-[33px] text-blue_gray-900_01 text-sm"
                        size="txtIBMPlexSansMedium14Bluegray90001"
                      >
                        000
                      </Text>
                      <Text
                        className="md:ml-[0] ml-[123px] text-black-900 text-sm"
                      ...
                      <Img
                        className="h-5 md:ml-[0] ml-[69px] w-[69px]"
                    ...
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <Img
                        className="h-5 md:ml-[0] ml-[69px] w-[69px]"
                        src="images/img_cut_deep_orange_500.svg"
                        alt="cut"
                      />
                    </div>
                    <Line className="self-center h-px bg-gray-300_08 w-full" />
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <Img
                        className="h-5 md:ml-[0] ml-[69px] w-[69px]"
                        src="images/img_cut_deep_orange_500_20x69.svg"
                        alt="cut"
                      />
                    </div>
                    <Line className="self-center h-px bg-gray-300_08 w-full" />
                    ...
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <Text
                        className="md:ml-[0] ml-[23px] text-blue_gray-900_01 text-sm"
                        size="txtIBMPlexSansMedium14Bluegray90001"
                      >
                        000
                      </Text>
