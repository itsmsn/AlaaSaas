...
const MasterVoucherDocsPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_29.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col gap-1.5 items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              <div className="flex sm:flex-col flex-row gap-[51px] items-center justify-start ml-0.5 md:ml-[0] w-[37%] md:w-full">
                <Input
                  name="frame1213"
              ...
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[27px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-center justify-start mb-12 w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-[89%] md:w-full">
                    <div className="flex flex-row sm:gap-10 items-center justify-between w-[56%] md:w-full">
...
export default MasterVoucherDocsPage;
