...
const PurchasePurchaseinvoicePage = () => {
  ...
  const table5Columns = React.useMemo(() => {
    ...
    return [
      table5ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table5ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table5ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table5ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table5ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table5ColumnHelper.accessor("rowquantity", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table5ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table5ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table5ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table5ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table5ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_35.svg" alt="group" />
      ),
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-500_31 border-solid flex flex-col items-center justify-start mt-5 p-3.5 rounded w-full">
                <div className="flex flex-col gap-4 items-start justify-start mb-1.5 w-[99%] md:w-full">
                  ...
                  <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
                    ...
                    >
                      <div className="h-[57px] sm:ml-[0] relative w-full">
                        <Text
                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 gap-[81px] items-start justify-start w-[96%] md:w-full">
              ...
              <Line className="bg-gray-400_03 h-px mt-[19px] w-full" />
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start mt-[17px] w-full">
...
export default PurchasePurchaseinvoicePage;
