...
const StocksStockIssuePage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_68.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            <div className="flex sm:h-[146px] h-[158px] md:h-[611px] justify-end relative w-full">
              ...
              <div className="absolute sm:h-[146px] h-[158px] md:h-[611px] inset-[0] justify-center m-auto w-full">
                <Img
                  ...
                  src="images/img_rectangle16_38.png"
                  alt="rectanglesixtee"
                />
                <div className="absolute sm:h-[146px] h-[158px] md:h-[611px] inset-[0] justify-center m-auto w-full">
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="flex h-[428px] sm:h-[443px] md:h-[504px] justify-end mt-4 relative w-full">
                ...
                <div className="absolute bg-white-A700 border border-gray-300_08 border-solid flex flex-col h-full inset-[0] items-center justify-center m-auto py-3.5 rounded-lg w-full">
                  <div className="flex flex-col items-center justify-start mb-[46px] w-full">
                    <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-[96%] md:w-full">
                      <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-[79%] md:w-full">
                        <div className="flex flex-row gap-2.5 items-start justify-between w-[16%] sm:w-full">
                          <Text
                        ...
                        <div className="flex flex-row gap-2.5 items-start justify-center w-[17%] sm:w-full">
                          <Text
                            className="text-base text-blue_gray-300_17"
                            size="txtIBMPlexSansMedium16Bluegray30017"
                          >
...
export default StocksStockIssuePage;
