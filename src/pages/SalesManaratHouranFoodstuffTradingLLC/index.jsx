...
const SalesManaratHouranFoodstuffTradingLLCPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_47.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col justify-start md:px-5 w-full">
            <div className="flex sm:h-[125px] h-[158px] md:h-[673px] justify-end relative w-full">
              ...
              <div className="absolute sm:h-[125px] h-[158px] md:h-[673px] inset-[0] justify-center m-auto w-full">
                <Img
                  ...
                  src="images/img_rectangle16_17.png"
                  alt="rectanglesixtee"
                />
                <div className="absolute sm:h-[125px] h-[158px] md:h-[673px] inset-[0] justify-center m-auto w-full">
                    ...
                    <div className="flex flex-col gap-[17px] items-center justify-start mt-1.5 w-[95%] md:w-full">
                      <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                        <div className="flex sm:flex-1 sm:flex-col flex-row gap-[3px] items-center justify-center w-auto sm:w-full">
                          ...
                          >
                            Manarat Houran Foodstuff Trading LLC
                          </Text>
                        </div>
            ...
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[27px] mt-1 w-[93%] md:w-full">
              <Text
            ...
            <div className="md:h-[1133px] sm:h-[1479px] h-[298px] md:ml-[0] ml-[13px] mt-[68px] relative w-[93%] md:w-full">
              ...
              <div className="absolute bottom-[0] flex sm:flex-col flex-row font-roboto gap-[41px] inset-x-[0] items-center justify-center mx-auto w-[48%]">
...
export default SalesManaratHouranFoodstuffTradingLLCPage;
