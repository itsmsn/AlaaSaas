...
const SalesPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_37.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 font-ibmplexsans h-[1041px] mx-auto relative w-full">
        ...
        <div className="absolute flex flex-col items-center justify-start md:px-5 right-[0] top-[0] w-[83%]">
          ...
          <div className="flex flex-col items-start justify-start mt-[47px] w-[93%] md:w-full">
            ...
            <div className="flex sm:flex-col flex-row md:gap-10 items-center justify-between ml-0.5 md:ml-[0] mt-[18px] w-full">
              <Button
                className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[126px] text-base text-center"
                shape="round"
              >
                Sales Enquiry
              </Button>
              ...
              <Button
                className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[142px] text-base text-center"
                shape="round"
              >
                Sales Quotation
              </Button>
              ...
              <Button
                className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[111px] text-base text-center"
                shape="round"
              >
                Sales Order
              </Button>
        ...
        <div className="absolute bottom-[33%] md:h-[47px] h-[87px] left-[36%] md:px-5 w-[14%]">
          <Line className="bg-blue-800 h-10 w-px" />
          <div className="absolute md:h-[47px] h-[87px] inset-[0] justify-center m-auto w-full">
            <div className="absolute h-[87px] inset-y-[0] my-auto right-[0] w-[6%]">
              <Img
                className="h-[47px] mb-[-7px] mx-auto z-[1]"
                src="images/img_arrowdown_blue_800.svg"
                alt="arrowdownone"
              />
              <Img
                className="h-[47px] mt-auto mx-auto"
        ...
        <div className="absolute bottom-[33%] flex flex-col items-start justify-start left-[24%] md:px-5 w-[12%]">
          <Line className="bg-blue-800 h-10 w-px" />
          <div className="h-[47px] relative w-full">
            <Img
              ...
              alt="arrowdowntwo"
            />
            <Line className="absolute bg-blue-800 h-px inset-x-[0] mx-auto top-[0] w-[97%]" />
          </div>
        </div>
        <div className="absolute bottom-[4%] flex flex-col inset-x-[0] items-center justify-start mx-auto md:px-5 w-full">
          <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
            ...
            <Button
              className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[142px] sm:ml-[0] ml-[54px] text-base text-center"
              shape="round"
            >
              Sales Quotation
            </Button>
            <Button
              className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[111px] sm:ml-[0] ml-[50px] text-base text-center"
              shape="round"
            >
              Sales Order
            </Button>
            <Button
              className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[125px] sm:ml-[0] ml-[309px] text-base text-center"
              shape="round"
            >
              Delivery Note
            </Button>
          </div>
          <div className="flex flex-col items-center justify-start mt-1 w-[87%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
              <Line className="bg-blue-800 h-10 md:h-px md:w-full w-px" />
              <Line className="bg-blue-800 h-10 md:h-px md:ml-[0] ml-[187px] md:w-full w-px" />
              <Line className="bg-blue-800 h-10 md:h-px md:ml-[0] ml-[175px] md:w-full w-px" />
              <Line className="bg-blue-800 h-10 md:h-px md:ml-[0] ml-[427px] md:w-full w-px" />
            </div>
            <div className="h-[47px] relative w-full">
              <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-[69%]">
            ...
            <div className="flex flex-row sm:gap-10 items-center justify-between mt-1 w-[83%] md:w-full">
              <Button
                className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[119px] text-base text-center"
                shape="round"
              >
                Sales Return
              </Button>
              <Button
                className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[123px] text-base text-center"
                shape="round"
              >
                Sales Invocie
              </Button>
            </div>
            <div className="flex flex-row sm:gap-10 items-center justify-between w-[68%] md:w-full">
              <Line className="bg-blue-800 h-10 w-px" />
              <Line className="bg-blue-800 h-10 w-px" />
            </div>
            <div className="h-[47px] relative w-[67%] sm:w-full">
              <Img
            ...
            <Button
              className="border border-blue-800 border-solid cursor-pointer font-semibold leading-[normal] min-w-[65px] mt-1 text-base text-center"
              shape="round"
            >
              Sales
            </Button>
        ...
        <div className="absolute bottom-[33%] flex flex-col items-center justify-start md:px-5 right-[8%] w-[28%]">
