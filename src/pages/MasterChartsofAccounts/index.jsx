...
const MasterChartsofAccountsPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_12.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col gap-2 items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col gap-[18px] items-start justify-start w-[94%] md:w-full">
              ...
              <div className="bg-gray-50_05 md:h-[209px] sm:h-[2310px] h-[296px] p-[21px] sm:px-5 relative shadow-bs4 w-full">
                ...
                <Img
                  className="absolute bottom-[9%] h-[18px] left-[4%] w-[18px]"
                  src="images/img_plus.svg"
                  alt="plus"
                />
                <div className="absolute bottom-[7%] flex sm:flex-col flex-row sm:gap-5 items-end justify-start left-[6%] w-[52%]">
                  <Img
                ...
                <List
                  className="absolute flex flex-col gap-7 left-[4%] top-[8%] w-3/5"
                  orientation="vertical"
                >
                  <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between w-[87%] md:w-full">
                    <Img
                  ...
                  <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-[90%] md:w-full">
                    <Img
                      className="h-[18px] w-[18px]"
                      src="images/img_plus.svg"
                      alt="plus"
                    />
                    <Img className="h-2.5" src="images/img_car.svg" alt="car" />
                    <Img
                      className="h-7 w-7"
                      src="images/img_computer.svg"
                      alt="computer"
...
export default MasterChartsofAccountsPage;
