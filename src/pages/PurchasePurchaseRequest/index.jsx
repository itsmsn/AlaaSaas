...
const PurchasePurchaseRequestPage = () => {
  ...
  const table1Columns = React.useMemo(() => {
    ...
    return [
      table1ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table1ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table1ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table1ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table1ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_31.svg" alt="group" />
      ),
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-500_31 border-solid flex flex-col items-center justify-start mt-5 p-3.5 rounded w-full">
                <div className="flex flex-col items-start justify-start w-[99%] md:w-full">
                  ...
                  <List
                    className="sm:flex-col flex-row gap-6 grid md:grid-cols-1 grid-cols-2 mt-[17px] w-[66%]"
                  ...
                  <div className="flex sm:flex-col flex-row sm:gap-10 gap-[88px] items-center justify-start mt-6 w-[61%] md:w-full">
              ...
              <Line className="bg-gray-400_03 h-px mt-[15px] w-full" />
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-[13px] w-full">
                ...
                <Button
                  className="border border-blue-800 border-solid cursor-pointer font-medium leading-[normal] mb-[3px] min-w-[201px] md:ml-[0] ml-[645px] text-base text-center"
                  shape="square"
                >
...
export default PurchasePurchaseRequestPage;
