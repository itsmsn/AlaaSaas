...
const PDCManagemenntPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_61.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col gap-[25px] items-center justify-start md:px-5 w-full">
            <div className="sm:h-[148px] h-[275px] md:h-[611px] relative w-full">
              ...
              <div className="absolute sm:h-[148px] h-[158px] md:h-[611px] inset-x-[0] mx-auto top-[0] w-full">
                <Img
                  className="h-[125px] mx-auto object-cover w-full"
                  src="images/img_rectangle16_31.png"
...
export default PDCManagemenntPage;
