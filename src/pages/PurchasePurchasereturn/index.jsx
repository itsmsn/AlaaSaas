...
const PurchasePurchasereturnPage = () => {
  ...
  const table6Columns = React.useMemo(() => {
    ...
    return [
      table6ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table6ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table6ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table6ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table6ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table6ColumnHelper.accessor("rowquantity", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table6ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table6ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table6ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table6ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table6ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_36.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <Sidebar
            ...
            className="!sticky !w-[250px] bg-blue-800 flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]"
          >
            <Img
            ...
            <Menu
              ...
              className="flex flex-col items-center justify-start mb-[131px] mt-[35px] pt-[3px] w-full"
            >
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-500_31 border-solid flex flex-col items-center justify-start mt-5 p-3.5 rounded w-full">
                <div className="flex flex-col items-center justify-start mb-2 w-[98%] md:w-full">
                  <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
                    <div className="md:h-[45px] h-[57px] relative w-[33%] md:w-full">
                    ...
                    <div className="md:h-12 h-[57px] relative w-[32%] md:w-full">
                      <Input
                        name="group208"
                    ...
                    <div className="h-[57px] relative w-[33%] md:w-full">
                      <Text
                      ...
                      <div className="bg-white-A700 border border-blue_gray-100_06 border-solid flex flex-col gap-[15px] items-end justify-start mt-auto mx-auto rounded w-full">
                        <Line className="bg-white-A700 h-px mr-[215px] w-[30%]" />
                        <Text
                          className="mb-2.5 mr-[212px] text-blue_gray-100_05 text-sm"
                          size="txtIBMPlexSansRegular14Bluegray10005"
                        >
                          purchase account
                        </Text>
                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-4 w-full">
                    <div className="h-[57px] relative w-[33%] md:w-full">
                      ...
                      <div className="bg-white-A700 border border-blue_gray-100_06 border-solid flex flex-col gap-[15px] items-center justify-start mt-auto mx-auto rounded w-full">
                        <Line className="bg-white-A700 h-px w-1/5" />
                        <Text
                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-1.5 w-[98%] md:w-full">
                    <div className="flex md:flex-col flex-row md:gap-[50px] items-start justify-between w-[65%] md:w-full">
                      <div className="md:h-[45px] h-[57px] relative w-[52%] md:w-full">
                        <div className="absolute bg-white-A700 border border-blue_gray-100_06 border-solid bottom-[0] flex flex-col gap-3 inset-x-[0] justify-start mx-auto rounded w-full">
                      ...
                      <div className="flex flex-row gap-3 items-end justify-start md:mt-0 mt-[23px] w-auto">
                        <Switch
                          onColor="#d1d1d6"
                          offColor="#d1d1d6"
                        ...
                        >
                          Enable to send mail to supplier
                        </Text>
                      </div>
                    </div>
                    <div className="flex flex-row gap-3 items-end justify-start md:mt-0 mt-[23px] w-auto">
                      ...
                      <Text
                        ...
                        size="txtIBMPlexSansRegular16Black900"
                      >
                        Enable to send SMS to Supplier
                      </Text>
                    </div>
                  </div>
                </div>
...
export default PurchasePurchasereturnPage;
