...
const SalessalesEnquiryPage = () => {
  ...
  const table7Columns = React.useMemo(() => {
    ...
    return [
      table7ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table7ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table7ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table7ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table7ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table7ColumnHelper.accessor("rowquantity", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table7ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table7ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table7ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table7ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table7ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_38.svg" alt="group" />
      ),
            ...
            <div className="flex flex-col items-start justify-start mt-1 w-[93%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-500_31 border-solid flex flex-col items-center justify-start mt-5 p-3.5 rounded w-full">
                <div className="flex flex-col items-start justify-start w-[99%] md:w-full">
                  ...
                  <div className="flex md:flex-col flex-row gap-6 items-center justify-start mt-4 w-[66%] md:w-full">
...
export default SalessalesEnquiryPage;
