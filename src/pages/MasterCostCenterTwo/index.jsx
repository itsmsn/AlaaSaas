...
const MasterCostCenterTwoPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_16.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="bg-gray-50_05 md:h-[1419px] h-[424px] sm:h-[514px] mt-[5px] p-[23px] sm:px-5 relative shadow-bs4 w-[94%] md:w-full">
              <div className="absolute flex flex-col h-max inset-y-[0] items-center justify-start left-[4%] my-auto w-[3%]">
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  <div className="flex flex-row gap-[22px] items-start justify-between w-full">
                    <Line className="bg-blue-800 h-[271px] mt-1.5 w-px" />
                    <div className="flex flex-col items-center justify-start">
                      <div className="flex flex-col items-center justify-start w-full">
                        <Line className="bg-blue_gray-400_19 h-11 w-px" />
                        <Line className="bg-blue-800 h-8 mt-3 w-px" />
                        <Line className="bg-blue-800 h-[33px] mt-3 w-px" />
                        <Line className="bg-blue-800 h-8 mt-[17px] w-px" />
                        <Line className="bg-blue-800 h-[33px] mt-3 w-px" />
                      </div>
                    </div>
                  </div>
              ...
              <div className="absolute flex sm:flex-col flex-row sm:gap-5 items-end justify-start left-[4%] top-[5%] w-[44%]">
              ...
              <div className="absolute flex flex-col gap-[27px] h-max inset-y-[0] justify-start left-[4%] my-auto w-[71%]">
                <List
                  className="flex flex-col gap-[26px] items-center ml-6 md:ml-[0] w-[97%]"
                  orientation="vertical"
                >
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-4/5 md:w-full">
                    <div className="h-3.5 md:mt-0 mt-0.5 relative w-[13%] md:w-full">
                      <Img
                    ...
                    <Img
                      className="h-[18px] md:ml-[0] ml-[11px] w-[18px]"
                      src="images/img_svgexport17_blue_gray_400_19.svg"
                      alt="svgexportsevent"
                    />
                    <Text
                      className="md:ml-[0] ml-[9px] text-black-900 text-sm"
                      size="txtIBMPlexSansRegular14Black900"
                    >
                      (1) A - AL RWAN FOODSTUFF TRADING
                    </Text>
                    <Img
                      className="h-2.5 md:ml-[0] ml-[18px] md:mt-0 mt-1"
                      src="images/img_car_blue_gray_400_19.svg"
                      alt="carone"
                    />
                    <Img
                    ...
                    />
                    <Img
                      className="h-2.5 md:ml-[0] ml-[13px] md:mt-0 mt-1"
                      src="images/img_car_blue_gray_400_19.svg"
                      alt="cartwo"
                    />
                    <Img
                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[91%] md:w-full">
                    <div className="h-3.5 md:mt-0 mt-0.5 relative w-[11%] md:w-full">
                      <Img
                        className="absolute h-2.5 inset-y-[0] my-auto right-[0]"
                        src="images/img_car_blue_gray_400_19_10x66.svg"
                        alt="car"
                    ...
                    <Text
                      ...
                      size="txtIBMPlexSansRegular14Black900"
                    >
                      (2) B - AL WAKEEL ALMUMYAZ TECHNICAL SERVICES
                    </Text>
                    <Img
                      className="h-2.5 ml-3.5 md:ml-[0] md:mt-0 mt-1"
                      src="images/img_car_blue_gray_400_19.svg"
                      alt="carone"
                    />
                    <Img
                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
                    <div className="h-3.5 md:mt-0 mt-0.5 relative w-[10%] md:w-full">
                      <Img
                        className="absolute h-2.5 inset-y-[0] my-auto right-[0]"
                        src="images/img_car_blue_gray_400_19_10x66.svg"
                        alt="car"
                    ...
                    <Text
                      ...
                      size="txtIBMPlexSansRegular14Black900"
                    >
                      (3) C - MANARAH AL SHAM VEGETABLES AND FRUIT Trading LLC
                    </Text>
                    <Img
                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[90%] md:w-full">
                    ...
                    <Text
                      ...
                      size="txtIBMPlexSansRegular14Black900"
                    >
                      (4) D - MANARAT HORAN FOODSTUFF TRADING LLC
                    </Text>
                    <Img
                      className="h-2.5 ml-3.5 md:ml-[0] md:mt-0 mt-1"
                      src="images/img_car_blue_gray_400_19.svg"
                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[81%] md:w-full">
                    <div className="h-3.5 md:mt-0 mt-0.5 relative w-[12%] md:w-full">
                      <Img
                        className="absolute h-2.5 inset-y-[0] my-auto right-[0]"
                        src="images/img_car_blue_gray_400_19_10x66.svg"
                        alt="car"
                    ...
                    <Text
                      ...
                      size="txtIBMPlexSansRegular14Black900"
                    >
                      (5) E - OSCAR VEGETABLES & FRUITS LLC
                    </Text>
                    <Img
                      className="h-2.5 ml-3.5 md:ml-[0] md:mt-0 mt-1"
                      src="images/img_car_blue_gray_400_19.svg"
                ...
                <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start w-[53%] md:w-full">
                  <Img
                    className="h-[18px] w-[18px]"
                    src="images/img_plus.svg"
                    alt="plus"
              ...
              <div className="absolute bottom-[7%] flex sm:flex-col flex-row sm:gap-5 items-center justify-start left-[4%] w-[37%]">
                <Img
                  className="h-[18px] w-[18px]"
                  src="images/img_plus.svg"
                  alt="plusone"
...
export default MasterCostCenterTwoPage;
