...
const PurchasePurchaseOrderPage = () => {
  ...
  const table3Columns = React.useMemo(() => {
    ...
    return [
      table3ColumnHelper.accessor("rowcode", {
        cell: (info) => (
          <Text
      ...
      table3ColumnHelper.accessor("rowproductname", {
        cell: (info) => (
          <Text
      ...
      table3ColumnHelper.accessor("rowdescription", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-blue_gray-900_01 text-sm"
            size="txtIBMPlexSansMedium14Bluegray90001"
      ...
      table3ColumnHelper.accessor("rowunit", {
        cell: (info) => (
          <Text
      ...
      table3ColumnHelper.accessor("rowvat", {
        cell: (info) => (
          <Text
      ...
      table3ColumnHelper.accessor("rowquantity", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table3ColumnHelper.accessor("rowunitprice", {
        cell: (info) => (
          <Text
            className="pb-[-5px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table3ColumnHelper.accessor("rowgross", {
        cell: (info) => (
          <Text
      ...
      table3ColumnHelper.accessor("rowdiscount", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table3ColumnHelper.accessor("rowtaxable", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
      ...
      table3ColumnHelper.accessor("rowroundvat", {
        cell: (info) => (
          <Text
            className="pb-[-4px] pt-[35px] text-black-900 text-sm"
            size="txtIBMPlexSansMedium14"
  ...
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_33.svg" alt="group" />
      ),
...
export default PurchasePurchaseOrderPage;
