  ...
  const sideBarMenu = [
    ...
    },
    {
      icon: (
        <Img
          className="h-7 w-7"
          src="images/img_group_gray_50_03_28x28.svg"
          alt="group"
        />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-[51px] items-center justify-start mt-[23px] w-[61%] md:w-full">
              ...
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[27px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-start justify-start mb-[15px] w-full">
                  <div className="flex flex-row sm:gap-10 items-center justify-between ml-10 md:ml-[0] w-[89%] md:w-full">
...
export default MasterCountryPage;
