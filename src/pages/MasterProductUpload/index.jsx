...
const MasterProductUploadPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_21.svg" alt="group" />
      ),
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              ...
              <div className="flex sm:flex-col flex-row sm:gap-5 items-end justify-start mt-5 w-[38%] md:w-full">
                <div className="md:h-[45px] h-[57px] relative w-[81%] sm:w-full">
                ...
                <Button
                  className="cursor-pointer font-semibold leading-[normal] min-w-[76px] sm:ml-[0] ml-[5px] sm:mt-0 mt-[9px] rounded shadow-bs text-base text-center"
                  shape="round"
                  color="blue_800"
                  size="sm"
                >
              ...
              <div className="flex sm:flex-col flex-row gap-[13px] items-center justify-start mt-6 w-1/2 md:w-full">
                <div className="flex sm:flex-col flex-row gap-4 items-center justify-between w-3/4 sm:w-full">
                  <div className="bg-white-A700 border border-dashed border-gray-500_35 flex flex-col items-center justify-start p-3 rounded w-[65%] sm:w-full">
                    <div className="flex flex-row gap-[23px] items-center justify-start w-auto">
                      ...
                      />
                      <Text
                        className="text-gray-500_36 text-sm w-auto"
                  ...
                  <div className="bg-white-A700 border border-blue-800 border-solid flex flex-row gap-[25px] items-center justify-start sm:mt-0 my-[3px] px-3 py-[9px] shadow-bs w-auto">
                    <Img
                      className="h-6 w-6"
                ...
                <div className="bg-white-A700 border border-blue-800 border-solid flex flex-row gap-[25px] items-center justify-start sm:mt-0 my-[3px] px-3 py-[9px] shadow-bs w-auto">
                  <Img
                    className="h-6 w-6"
                    src="images/img_upload86900511.svg"
                    alt="upload86900511"
                  />
                  <Text
                    className="text-base text-blue-800 w-auto"
              ...
              <Input
                ...
                wrapClassName="border border-blue-800 border-solid flex ml-0.5 md:ml-[0] mt-6 shadow-bs w-[17%]"
                prefix={
                  <Img
                ...
                size="xs"
              ></Input>
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[17px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-center justify-start mb-[46px] w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-[98%] md:w-full">
                    ...
                    <div className="flex flex-row gap-[9px] items-center justify-center md:ml-[0] ml-[70px] w-auto">
                      <Text
                        className="text-base text-blue_gray-300_17 w-auto"
                        size="txtIBMPlexSansMedium16Bluegray30017"
                      >
                    ...
                    <div className="flex flex-row gap-[9px] items-center justify-center ml-12 md:ml-[0] w-auto">
                      <Text
                        className="text-base text-blue_gray-300_17 w-auto"
                        size="txtIBMPlexSansMedium16Bluegray30017"
                      >
                  ...
                  <div className="flex flex-col gap-[59px] items-center justify-start mt-[78px] w-[96%] md:w-full">
...
export default MasterProductUploadPage;
