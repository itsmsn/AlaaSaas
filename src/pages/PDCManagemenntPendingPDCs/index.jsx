...
const PDCManagemenntPendingPDCsPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_62.svg" alt="group" />
      ),
            ...
            <div className="flex sm:h-[125px] h-[158px] md:h-[674px] justify-end relative w-full">
              ...
              <div className="absolute sm:h-[125px] h-[158px] md:h-[674px] inset-[0] justify-center m-auto w-full">
                <Img
                  ...
                  src="images/img_rectangle16_32.png"
...
export default PDCManagemenntPendingPDCsPage;
