...
const MasterCurrencyPage = () => {
  const sideBarMenu = [
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_4.svg" alt="group" />
      ),
            ...
            <div className="flex flex-col items-start justify-start w-[93%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start mt-[23px] w-[94%] md:w-full">
                ...
                <div className="md:h-[45px] h-[57px] ml-6 md:ml-[0] relative w-[33%] md:w-full">
                  <div className="absolute bg-white-A700 border border-blue_gray-100_06 border-solid bottom-[0] flex flex-col gap-[15px] inset-x-[0] justify-start mx-auto rounded w-full">
                    <Line className="bg-white-A700 h-px md:ml-[0] ml-[21px] mr-[260px] w-[17%]" />
                    <Text
                      className="mb-2.5 ml-3 md:ml-[0] mr-60 text-blue_gray-100_05 text-sm"
              ...
              <div className="bg-white-A700 border border-gray-300_08 border-solid flex flex-col items-center justify-start mt-[27px] py-3.5 rounded-lg w-full">
                <div className="flex flex-col items-start justify-start mb-[9px] w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between ml-10 md:ml-[0] w-[88%] md:w-full">
