...
const MasterChartsofAccountsTwoPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    {
      icon: (
        <Img className="h-7 w-7" src="images/img_group_13.svg" alt="group" />
      ),
      ...
      <div className="bg-white-A700 flex flex-col font-ibmplexsans items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col gap-2 items-center justify-start md:px-5 w-full">
            <div className="sm:h-[157px] h-[198px] md:h-[704px] relative w-full">
              <div className="absolute flex flex-col gap-[11px] h-max inset-[0] justify-center m-auto w-full">
                <div className="flex sm:h-[125px] h-[158px] md:h-[672px] justify-end relative w-full">
                  ...
                  <div className="absolute sm:h-[125px] h-[158px] md:h-[672px] inset-[0] justify-center m-auto w-full">
                    ...
                    >
                      ...
                      >
                        <Text size="txtIBMPlexSansMedium16Blue800">
                          Support
                        </Text>
                      </a>
                    </div>
                ...
                <Text
                  className="md:ml-[0] ml-[27px] text-base text-gray-600_22"
              ...
              <Button
                className="border border-blue-800 border-solid bottom-[0] cursor-pointer flex items-center justify-center min-w-[160px] mr-[217px] right-[18%]"
                leftIcon={
                  <Img
                    className="h-6 mr-[17px] right-[1%] absolute"
                    src="images/img_3dstudentgrad.svg"
                    alt="add-file_1486753 1"
                  />
                }
              ...
              <Button
                className="border border-blue-800 border-solid bottom-[0] cursor-pointer flex items-center justify-center min-w-[151px] mr-[57px] right-[5%]"
                leftIcon={
                  <Img
                    className="h-6 mr-[17px] right-[1%] absolute"
                    src="images/img_block4491563_1_1.svg"
            ...
            <div className="flex flex-col gap-[15px] items-start justify-start w-[94%] md:w-full">
              ...
              <div className="bg-gray-50_05 sm:h-[2310px] md:h-[351px] h-[450px] p-[26px] sm:px-5 relative shadow-bs4 w-full">
                <div className="absolute md:h-[133px] sm:h-[1590px] h-[169px] left-[6%] top-[6%] w-3/5 md:w-full">
                  <div className="absolute flex flex-col h-max inset-y-[0] items-center justify-start left-[1%] my-auto w-[1%]">
                    <div className="flex flex-col gap-3 items-center justify-start w-full">
                      ...
                      <Line className="bg-blue-800 h-8 w-px" />
                      <Line className="bg-blue-800 h-[33px] w-px" />
                    </div>
                  </div>
                  <div className="absolute flex sm:flex-col flex-row sm:gap-5 items-end justify-start left-[11%] top-[0] w-[73%]">
                    <Img
                      className="h-7 w-7"
                      src="images/img_computer.svg"
                      alt="computer_Five"
                  ...
                  <Img
                    className="absolute h-2.5 left-[1%] top-[5%]"
                    src="images/img_car.svg"
                    alt="car_Three"
                  />
                  <List
                    className="absolute bottom-[0] flex flex-col gap-[18px] inset-x-[0] items-center mx-auto w-full"
                  ...
                  >
                    ...
                    <div className="flex md:flex-1 sm:flex-col flex-row sm:gap-10 items-end justify-between mr-[73px] my-0 w-[89%] md:w-full">
                      <div className="h-3.5 md:h-7 sm:h-[21px] sm:mt-0 my-[7px] relative w-[13%] sm:w-full">
                        <Img
                          className="absolute h-2.5 inset-y-[0] my-auto right-[0]"
                          src="images/img_car_blue_gray_400_19_10x66.svg"
                ...
                <div className="absolute sm:h-[2310px] md:h-[351px] h-[388px] inset-y-[0] left-[4%] my-auto w-3/5 md:w-full">
                  <div className="absolute flex flex-col h-max inset-y-[0] items-center justify-start left-[1%] my-auto w-[1%]">
                    <div className="flex flex-col items-center justify-start w-full">
                      <Line className="bg-blue-800 h-[183px] w-px" />
...
export default MasterChartsofAccountsTwoPage;
